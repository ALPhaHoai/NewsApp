...
export const VolumeIcon: React.FC<{size?: number; color?: string}> = ({
  size = 22,
  color = '#039ed8',
}) => (
...
export const StopIcon: React.FC<{size?: number; color?: string}> = ({
  size = 22,
  color = '#d41515',
}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  return (
    <Animated.View style={{transform: [{scale}], alignSelf: 'flex-start'}}>
      {!reading ? (
        ...
        <TouchableOpacity
          style={[styles.ttsBtn, {backgroundColor: '#EAEDF0'}, style]}
          onPress={onStop}
          accessibilityRole="button"
